...
class WsalestockController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('permission:View wStocks', only: ['index','wsalestockdata']),
        ];
    }
    ...
    {
        return view('admin.pages.wholesale.wsalestock.wsalestock');
    }
