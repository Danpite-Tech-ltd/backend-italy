...
class SupplierController extends Controller implements HasMiddleware
{
    ...
    public function store(Request $request)
    {
      ...
      //  $supplier->piva = $request->piva;
      //  $supplier->codice_fiscal = $request->codice_fiscal;
      //  $supplier->cap = $request->cap;
      //  $supplier->pec = $request->pec;
      //  $supplier->catasto_destinatario = $request->catasto_destinatario;
