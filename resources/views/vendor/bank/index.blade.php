...
@section('content')
    ...
    @if(Auth::guard('vendor')->id() && $bankSetup)
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('vendor.bank.update', $bankSetup->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="country" name="country" placeholder="Enter Country"
                                    value="{{ $bankSetup->country ?? '' }}" required>
                            </div>

                            <button type="submit" class="mr-2 btn btn-primary">Update Bank Details</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('vendor.bank.store') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="routing_number">Routing Number</label>
                                <input type="text" class="form-control" id="routing_number" name="routing_number"
                                    placeholder="Enter Routing Number" value="{{ old('routing_number') }}" required>
                            </div>

                            <div class="form-group">
                                <label for="iban_number">Iban Number</label>
                                <input type="text" class="form-control" id="iban_number" name="iban_number"
                                    placeholder="Enter Iban Number" value="{{ old('iban_number') }}" required>
                            </div>

                            <div class="form-group">
                                <label for="swift_code">Swift Code</label>
                                <input type="text" class="form-control" id="swift_code" name="swift_code"
                                    placeholder="Enter Swift Code" value="{{ old('swift_code') }}" required>
                            </div>

                            <div class="form-group">
                                <label for="branch_city">Branch City</label>
                                <input type="text" class="form-control" id="branch_city" name="branch_city"
                                    placeholder="Enter Branch City" value="{{ old('branch_city') }}" required>
                            </div>
                            ...
                            <button type="submit" class="mr-2 btn btn-primary">Add Bank Details</button>
                        </form>
                    </div>
                </div>
            </div>
