...
<body>
    @foreach ($orders as $vendorOrder)
        @php
            ...
            $products = $vendorOrder->orderProducts;
            $status = App\Models\OrderStatus::where('id', $order->order_status_id)->first();
            $vendor = App\Models\Vendor::where('id', $vendorOrder->vendor_id)->first();
        @endphp
        <div class="invoice-page @if (!$loop->last) page-break @endif">
            ...
            <div class="invoice-header">
                ...
                <div class="company-logo">
                    <img src="{{ asset($vendor->profile_image) ?? '' }}" alt="Company Logo">
                </div>
            </div>
            ...
            <div class="invoice-meta">
                <div class="meta-table">
                    ...
                    <div class="row">
                        ...
                        <span class="value">{{ $status->status_name ?? 'N/A' }}</span>
                    </div>
                </div>
