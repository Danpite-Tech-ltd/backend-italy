...
@push('js')
    ...
    <script>
        ...
        $(document).on("click", "#submit", function () {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('vendor.product-variant.store')}}',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $("#mediavariantID").select2({
            ...
            ajax: {
                type: 'GET',
                url: '{{ route('vendor.product.color') }}',
        ...
        $("#sizevariantID").select2({
            ...
            ajax: {
                type: 'GET',
                url: '{{route('vendor.product.variant')}}',
                processResults: function (data) {
    ...
    <script>
        ...
        let adminTable = $('#adminTable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('/vendor/variant-products/'.$id) }}",
            // pageLength: 30,
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: "{{ url('vendor/delete-product-variant') }}/" + id,
                            data: {
                                '_token': token
                            },
...
<script>
        ...
        function showPreview(file) {
            ...
            `;
                ...
                document.getElementById('img-preview').appendChild(previewDiv);
            };
