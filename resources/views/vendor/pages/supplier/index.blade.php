...
@section('content')
    ...
    {{--    Create Admin Modal --}}
    <div class="modal fade" id="createAdminModal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;"
        aria-hidden="true">
    ...
    <div class="modal fade" id="editAdminModal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            let adminTable = $('#adminTable').DataTable({
                ...
                ajax: "{{ route('vendor.supplier.index') }}",
                // pageLength: 30,
            ...
            $('#createAdmin').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('vendor.supplier.store') }}",
                    data: formData,
  ...
  $(document).on('click', '.editButton', function () {
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('vendor/suppliers') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
            ...
            $(document).on('click', '#adminStatus', function() {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('vendor.supplier.status') }}",
                    data: {
                        '_token': token,
                        id: id,
                        status: status
