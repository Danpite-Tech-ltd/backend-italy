    ...
    <table class="main-table">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="right" style="vertical-align: middle;">
                            <span style="background-color: #4f46e5; color: #ffffff; padding: 8px 15px; font-size: 13px; font-weight: 700; border-radius: 4px; text-transform: uppercase;">
                                Confirmed
                            </span>
                        </td>
                    </tr>
        ...
        <tr>
            <td class="content">
                ...
                <p class="intro-text">
                    Your order has been successfully received and is now being processed. Below you will find the complete breakdown of your invoice details and purchased items.
                </p>
                    ...
                    <tr>
                        <td class="meta-card">
                            ...
                            <p class="card-text">
                                ...
                                <strong>Date:</strong> {{ \Carbon\Carbon::parse($order->order_date)->format('M d, Y h:i A') }}<br>
                                <strong>Payment:</strong> {{ $order->payment_method ?? strtoupper($order->payment) }}
                            </p>
                        </td>
                        <td width="4%">&nbsp;</td>
                        <td class="meta-card">
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right"><strong>{{ number_format($product->product_price * $product->quantity, 2) }}</strong></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <table class="summary-table" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="summary-label" style="color: #10b981;">Discount ({{ $order->coupon_name }}):</td>
                        <td class="summary-value" style="color: #10b981;">-{{ number_format($order->coupon_discount, 2) }}</td>
                    </tr>
                    @endif
                ...
                <div style="background-color: #fff7ed; border-left: 4px solid #ea580c; padding: 15px; margin-top: 20px; border-radius: 4px;">
                    <p style="margin: 0; font-size: 13px; font-weight: 700; color: #c2410c; text-transform: uppercase;">Your Note:</p>
                    <p style="margin: 5px 0 0 0; font-size: 14px; color: #9a3412; font-style: italic;">"{{ $order->customer_note }}"</p>
                </div>
                @endif

                @if($order->reward_point > 0)
                <p style="font-size: 14px; color: #4f46e5; font-weight: 600; margin-top: 20px;">
                    🎉 Congratulations! You have earned <strong>{{ $order->reward_point }}</strong> reward points from this order.
                </p>
                @endif
        ...
        <tr>
            <td class="footer">
                ...
                <p style="margin: 0;">If you have any questions or queries regarding this invoice, please reach out to our helpdesk.</p>
            </td>
        </tr>
    </table>
</center>
