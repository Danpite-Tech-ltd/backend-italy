                        ...
                        <form method="POST" class="row" action="{{ route('admin.product.update', $product->id) }}"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="testSelect" class="form-control select2" value="{{ old('vendor_id') }}"
                                        name="vendor_id">
                                        <option value="">Select..</option>
                                        @foreach ($vendors as $value)
                                            <option value="{{ $value->id }}"
                                                @if ($product->vendor_id == $value->id) selected @endif>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="" class="form-control select2" value="{{ old('branch_id') }}"
                                        name="branch_id">
                                        <option value="">Select..</option>
                                        @foreach ($branches as $value)
                                            <option value="{{ $value->id }}"
                                                @if ($product->branch_id == $value->id) selected @endif>{{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="" class="form-control select2" value="{{ old('warehouse_id') }}"
                                        name="warehouse_id">
                                        <option value="">Select..</option>
                                        @foreach ($warehouses as $value)
                                            <option value="{{ $value->id }}"
                                                @if ($product->warehouse_id == $value->id) selected @endif>{{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group control-group increment">
                                    ...
                                    <div id="imgPreview">
                                        @if (isset($product->thumbnail_img))
                                            <img src="{{ asset($product->thumbnail_img) }}" width="50px"
                                                height="50px" alt="Thumbnail image">
                                        @endif
                                    </div>
