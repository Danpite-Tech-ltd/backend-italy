            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form" id="createAdmin">
                        ...
                        <div class="mb-3">
                            <label for="subcategory_id" class="col-form-label">Sub Category</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="name" class="col-form-label">Child Category Name *</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let adminTable = $('#adminTable').DataTable({
                ...
                serverSide: true,
                {{--ajax: "{{url('/admin/data')}}",--}}
                ajax: "{{route('admin.child-category.index')}}",
                // pageLength: 30,
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('admin/child-categories') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
                        ...
                        success: function (res) {
                            ...
                            $('#metaImgPrev').empty();
                            $('#metaImgPrev').append(
                                `<img id="profileImg" src="{{asset('')}}${res.data.meta_image}" width="300px" height="100px">`
                            );
            ...
            $('#editAdmin').submit(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('admin/child-categories') }}/" + id,
                    data: formData,
                    processData: false,  // Prevent jQuery from processing the data
                    contentType: false,  // Prevent jQuery from setting contentType
                    success: function (res) {
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    Swal.fire({
                                        title: "Deleted!",
                                        text: "Child category has been deleted.",
                                        icon: "success"
                                    });
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.child-category.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
