            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 card-title">Pending Vendors List</h4>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            let vendorTable = $('#vendorTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.pending.vendor.list')}}",
                // pageLength: 30,
            ...
            $(document).on('click', '#deleteVendorBtn', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ url('admin/pending/vendors/delete') }}/" + id,
                            type: 'GET',
            ...
            $(document).on('click', '.vendorStatus', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{route('admin.pending.vendor.status')}}",
                    data: {
                        _token: token,
                        id: id,
                        status: status
