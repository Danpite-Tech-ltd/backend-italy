            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 card-title">Discount List</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form" id="createAdmin">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label">Discount Title *</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="name" class="col-form-label">Discount Title *</label>
                        ...
                        <div class="mb-3">
                            <label for="type" class="col-form-label">Discount type *</label>
        ...
        $(document).ready(function () {
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('admin/discounts') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    Swal.fire({
                                        title: "Deleted!",
                                        text: "Discounts has been deleted.",
                                        icon: "success"
                                    });
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.discount.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
