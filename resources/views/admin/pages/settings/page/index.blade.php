            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0 card-title">Page List</h4>
                        @can('Create Page')
                            <a class="btn btn-md btn-secondary" href="{{ route('admin.page.create') }}">
                                Add Page
                            </a>
                        @endcan
                    </div>
                        ...
                        <table class="table mb-0 nowrap w-100 dataTable no-footer dtr-inline table-striped"
                            ...
                            @forelse($pages as $page)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $page->type == 1)
                                            <a class="badge bg-info">Customer Support</a>

                                        @else
                                            <a class="badge bg-danger">Legal</a>
                                        @endif
                                    </td>
                                    <td>
                                        @if( $page->status == 1)
                                    ...
                                    <td>
                                        <div class="gap-3 d-flex">
                                            ...
                                            @can('Delete Page')
                                                <form method="post" id="delete-form-{{$page->id}}"
