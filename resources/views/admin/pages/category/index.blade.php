            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form" id="createAdmin">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label">SKU Prefix *</label>
                            <input type="text" class="form-control" name="SKU_prefix" required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="SKU_prefix" class="col-form-label">SKU Prefix *</label>
                            <input id="SKU_prefix" type="text" class="form-control" name="SKU_prefix" required>
                        </div>
                ...
                $.ajax(
                    {
                        ...
                        success: function (res) {
                            ...
                            $('#SKU_prefix').val(res.data.SKU_prefix);
