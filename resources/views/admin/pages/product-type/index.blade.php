            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Flash Sale / Daily Deals</h4>
                        {{--                                                       @can('Create Admin')--}}
        ...
        $(document).ready(function () {
            ...
            $('#createAdmin').submit(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.product-type.store') }}",
                    data: formData,
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('admin/product-types') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
            ...
            $('#editAdmin').submit(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('admin/product-types') }}/" + id,
                    data: formData,
                    processData: false,  // Prevent jQuery from processing the data
                    contentType: false,  // Prevent jQuery from setting contentType
                    success: function (res) {
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.product-type.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
