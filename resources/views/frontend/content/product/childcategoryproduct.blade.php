...
@section('maincontent')
    @section('meta')
        ...
        <meta itemprop="image" content="{{asset($subcategory->meta_image)}}"/>
        ...
        <meta property="og:image" content="{{asset($subcategory->meta_image)}}"/>
        ...
        <meta name="twitter:image" content="{{asset($subcategory->meta_image)}}"/>

        <script type="application/ld+json">
            {!! $subcategory->google_schema !!}
        </script>
                    ...
                    <aside class="col-lg-3 col-xl-5col order-lg-first">
                        <div class="sidebar sidebar-shop">
                            <div class="widget widget-categories">
                                <h3 class="widget-title" id="c-title">ChildCategory</h3><!-- End .widget-title -->
                                                    ...
                                                    <div class="collapse-wrap">
                                                        <ul class="mb-0">
                                                            @forelse($cate->subcategories as $subcate)
                                                                <li>
                                                                    <a @if($subcate->id == $subcategory->id) class="ct-active"
                                                                       @endif href="{{url('subcategory',$subcate->slug)}}">{{$subcate->name}}</a>
                                                                </li>
                                                            @empty
                                                            @endforelse
                                                        </ul>
                            ...
                            {{--                                    <a href="#">--}}
                            {{--                                        <img src="{{asset('public/frontend/assets')}}/images/demos/demo-13/banners/banner-6.jpg" alt="banner">--}}
                            {{--                                    </a>--}}
                            {{--                                </div><!-- End .banner-ad -->--}}
                            {{--                            </div><!-- End .widget -->--}}
