            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-xl-4-5col">
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    {{ count($recomands) }} Products found
                                </div><!-- End .toolbox-info -->
                            </div><!-- End .toolbox-left -->
                        </div><!-- End .toolbox -->

                        <div class="mb-3 products">
                            <h3 class="text-center">Recommendation For You</h3>
                            <div class="row">
                        ...
                        {{ $recomands->links('pagination::bootstrap-4') }}
                                ...
                                <div class="widget-body">
                                    <div class="accordion" id="widget-cat-acc">
                                        @forelse($categories as $ind=>$cate)
                                            <div class="acc-item">
                                                <h5>
                                                    <a @if($cate->id == $settings->id) class="ct-active"
                                                ...
                                                <div id="collapse-{{$ind}}"
                                                     class="collapse @if($cate->id == $settings->id) show @endif"
